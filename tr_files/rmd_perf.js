...
(function(){
try {
   var timings = [ { marker: 'knitr', elapsed: 680 }, { marker: 'pandoc', elapsed: 1650 }, { marker: 'post-processor', elapsed: 20 }, { marker: 'pre-processor', elapsed: 40 }, { marker: 'render', elapsed: 8050 } ];
